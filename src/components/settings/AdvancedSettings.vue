        ...
        <SettingPlan :default-value="['0', '1']">
            ...
            >
                <SettingItem
                    ...
                    title="开发者模式"
                    tooltip="启用开发者选项和调试功能"
                    type="text"
                    right-control="switch"
                    readonly
                    @update:model-value="saveDeveloperMode"
                />

                <SettingItem
                    v-model="debugLogging"
                    title="调试日志"
                    tooltip="记录详细的调试信息到日志文件"
                    type="text"
                    right-control="switch"
                    readonly
                    @update:model-value="saveDebugLogging"
                />

                <SettingItem
                    v-model="dataCollection"
                    title="数据收集"
                    tooltip="允许收集匿名使用数据以改进产品"
                    type="text"
                    right-control="switch"
                    readonly
                    @update:model-value="saveDataCollection"
                />
            </SettingCard>
