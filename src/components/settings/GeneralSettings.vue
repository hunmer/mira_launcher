    ...
    <div class="space-y-6">
        <SettingPlan :default-value="['0', '1', '2']">
            ...
            >
                <SettingItem
                    title="主题模式"
                    tooltip="切换应用的明暗主题模式，影响整体界面色彩方案"
                    type="button"
                    :button-label="isDark ? '切换到浅色模式' : '切换到深色模式'"
